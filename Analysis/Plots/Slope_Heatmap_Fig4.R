###-----------------------------------------------------------------------------------------###
### TITLE:       Slope Heatmap.                                                             ###
### DESCRIPTION: Plots figure 4:                                                            ###
###              "Model-based Impact Analysis of Climate Change and Land-use Intensification###
###              on Trophic Networks."                                                      ###                                                                 
### PROCEDURE:   Performs linear regression for each region, functional group, and          ###
###              simulation experiment. Extracts the results, and plots the slope parameter ###
###              estimates in a heatmap                                                     ###
### NOTE:        Script can be performed for aggregated, or all FGs, has to be defined at   ###
###              at the start of the script (FGs <- ...)                                    ###
### DATE:        23.03.2024                                                                 ###
###-----------------------------------------------------------------------------------------###
