...
### DESCRIPTION: Plots percentage change results as barplot for:                            ###
...
figpath <- "/Users/neumanch/Desktop/Thesis/bpm-madingley/Christians Projects/MadingleyR_Sep_2023/Figpath/"
...
ggsave(paste0(figpath,sep="_","PercentageChange_Barplot.png"),dpi=1200,width=250,height=360,units="mm")
...
#save pdf file in dina4
ggsave(paste0(figpath,sep="_","Overall_Percentage_Change_Regions.png"),dpi=1200,width=250,height=120,units="mm")
