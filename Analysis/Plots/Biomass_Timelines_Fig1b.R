###-----------------------------------------------------------------------------------------###
### TITLE:       Biomass_Timelines_Fig1b                                                    ###
### DESCRIPTION: Plots figure 1b of:                                                        ###
###              "Model-based Impact Analysis of Climate Change and Land-use Intensification###
###              on Trophic Networks."                                                      ###                                                                 
### PROCEDURE:   Plots biomass timelines for each scenario and functional group of France   ###                                            ###
### DATE:        04.08.2023                                                                 ###
###-----------------------------------------------------------------------------------------###
...
#load input
load(paste(getwd(), "Input", "France", "Output_Summary.Rdata", sep = "/"))
...
pdf(paste(getwd(), "Output", "Fig1b.pdf", sep = "/"), width = 13, height = 5)
...
dev.off()
ggsave(paste(getwd(), "Output", "Fig1b.png", sep = "/"),dpi=1200,width=360,height=125,units="mm")
